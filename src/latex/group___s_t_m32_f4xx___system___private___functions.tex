...
\begin{DoxyItemize}
\item If SYSCLK source is HSI, System\+Core\+Clock will contain the HSI\+\_\+\+VALUE($\ast$)
\item If SYSCLK source is HSE, System\+Core\+Clock will contain the HSE\+\_\+\+VALUE($\ast$$\ast$)
\item If SYSCLK source is PLL, System\+Core\+Clock will contain the HSE\+\_\+\+VALUE($\ast$$\ast$) or HSI\+\_\+\+VALUE($\ast$) multiplied/divided by the PLL factors.
\end{DoxyItemize}
